...
/**
 * One invoice per seller per calendar billing month (postpaid).
 * GMV, plan, and amounts are frozen at generation time — settlement only moves
 * paid/waived/adjustment/outstanding via appended SubscriptionTransaction docs.
...
subscriptionInvoiceSchema.index({ sellerId: 1, billingMonth: 1 }, { unique: true });
