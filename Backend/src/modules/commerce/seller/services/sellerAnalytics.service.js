 ...
 * (`sellerId, orderStatus, createdAt`), and no row limit applies.
 *
...
export async function getSellerAnalytics(sellerId, query = {}) {
    ...
    const delivered = { sellerId: rId, orderStatus: 'delivered' };
