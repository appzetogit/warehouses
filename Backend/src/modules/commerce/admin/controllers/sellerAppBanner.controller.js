...
import * as svc from '../services/sellerAppBanner.service.js';
...
// ── Seller partner app ──
export async function listBannersForSellerAppController(_req, res, next) {
    try {
        return sendResponse(res, 200, 'Banners fetched', await svc.listBannersForSellerApp());
    } catch (e) { next(e); }
}
