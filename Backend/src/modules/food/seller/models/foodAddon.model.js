...
const foodAddonSchema = new mongoose.Schema(
    {
        ...
        //
        // EMPTY MEANS SELLER-WIDE, which is how every add-on behaved before this
        ...
        // Draft is what seller is editing and what admin approves/rejects.
        ...
        // Operational toggle controlled by seller; user app filters on this.
...
foodAddonSchema.index({ sellerId: 1, isDeleted: 1, createdAt: -1 });
// Serves the user app's per-item lookup: approved + available + attached to this item.
foodAddonSchema.index({ sellerId: 1, foodIds: 1, approvalStatus: 1, isAvailable: 1 });
foodAddonSchema.index({ approvalStatus: 1, isDeleted: 1, requestedAt: -1 });
foodAddonSchema.index({ sellerId: 1, approvalStatus: 1, isDeleted: 1, requestedAt: -1 });
