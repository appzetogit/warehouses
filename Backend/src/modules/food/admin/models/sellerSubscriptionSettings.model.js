...
const sellerSubscriptionSettingsSchema = new mongoose.Schema(
    ...
    { collection: 'food_seller_subscription_settings', timestamps: true }
);

export const FoodSellerSubscriptionSettings = mongoose.model('FoodSellerSubscriptionSettings', sellerSubscriptionSettingsSchema);
