...
const worstCase = {
    ...
    sellerImage: 'https://res.cloudinary.com/demo/image/upload/v1234567890/restaurants/covers/a-fairly-long-cover-name.jpg',
    pickupLat: '22.728236',
