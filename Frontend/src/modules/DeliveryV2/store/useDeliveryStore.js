...
export const useDeliveryStore = create(
  persist(
    (set, get) => ({
      ...
      // --- Live road route metrics (from Google Directions on LiveMap) ---
      ...
      setRouteMetrics: ({ distanceMeters = null, durationMins = null } = {}) =>
        set({
      ...
      clearRouteMetrics: () =>
        set({ routeDistanceMeters: null, routeDurationMins: null }),
