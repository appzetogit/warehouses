...
export default function VerificationPending() {
  ...
  useEffect(() => {
    ...
    const checkApprovalStatus = async () => {
      const token = getModuleToken("seller")
      if (!token) {
        ...
        <div className="rounded-[28px] border border-slate-200 bg-white p-8 shadow-[0_24px_70px_rgba(15,23,42,0.08)]">
          ...
          <div className="mb-6 text-center">
            ...
            <p className="mt-3 text-sm leading-6 text-slate-600">
              {companyName} received your onboarding details successfully. Our team will verify your seller and activate your dashboard once approval is complete.
            </p>
            {checkingStatus ? (
