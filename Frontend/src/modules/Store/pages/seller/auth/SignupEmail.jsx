...
export default function SellerSignupEmail() {
  ...
  const handleFormSubmit = async (e) => {
    ...
    setIsLoading(true)
    try {
      await sellerAPI.sendOTP(null, "register", formData.email)
      setStep(2)
      setResendTimer(60)
          ...
          <Card className="w-full max-w-lg bg-white/80 backdrop-blur-sm border border-gray-200 shadow-xl">
            <CardHeader>
              ...
              <CardDescription className="text-sm text-gray-500">
                {step === 1
                  ? "Sign up to start managing your seller"
