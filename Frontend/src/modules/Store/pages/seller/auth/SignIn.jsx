...
import { isModuleAuthenticated, setAuthData } from "@store/utils/auth"
...
export default function SellerSignIn() {
  ...
  // Redirect to seller home if already authenticated
  useEffect(() => {
    const isAuthenticated = isModuleAuthenticated("seller")
    if (isAuthenticated) {
      ...
      <div className="w-full lg:w-1/2 h-full flex flex-col">
        ...
        >
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input
                  id="email"
                  type="email"
                  placeholder="test.seller@gmail.com"
                  value={email}
          ...
          <div className="mt-6 text-center text-sm text-gray-600">
            ...
            <button
              onClick={() => navigate("/seller/signup-email")}
              className="text-primary-orange hover:underline font-medium"
            >
              Sign up
            </button>
          ...
          <div className="mt-8 w-full max-w-lg rounded-lg border border-orange-100 bg-orange-50 px-4 py-3 text-xs sm:text-sm text-gray-800 flex items-start gap-3">
            ...
            <div>
              ...
              <div>
                <span className="font-semibold">Email :</span> test.seller@gmail.com
              </div>
              <div>
