...
export default function SellerGoogleCallback() {
      ...
      try {
        ...
        if (errorParam) {
          ...
          const errorMessages = {
            ...
            wrong_role: "This account is not registered as a seller partner.",
        ...
        // Redirect to seller home after short delay
        setTimeout(() => {
          navigate("/seller")
        }, 1200)
      } catch (err) {
        debugError("Seller Google auth error:", err)
        setStatus("error")
        setError(
      ...
      <div className="w-full max-w-md bg-white rounded-xl shadow-lg p-6 space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-gray-600">
            {status === "loading" &&
              `Connecting your ${provider || "Google"} account to ${companyName} Seller Panel...`}
            {status === "success" && "You will be redirected to your seller panel shortly."}
