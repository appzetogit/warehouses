...
const databaseTables = [
  ...
  { name: "Seller_configs", count: 9 },
  { name: "Seller_tag", count: 0 },
  ...
  { name: "Product_nutrition", count: 7 },
  ...
  { name: "Seller_schedule", count: 105 },
  { name: "Seller_wallets", count: 15 },
  { name: "Shifts", count: 3 },
  ...
  { name: "Seller_subscript...", count: 5 },
  { name: "Sellers", count: 16 },
