...
export const exportToCSV = (orders, filename = "orders") => {
  ...
  if (isSubscription) {
    headers = ["SI", "Subscription ID", "Order Type", "Duration", "Seller", "Customer Name", "Customer Phone", "Status", "Total Orders", "Delivered"]
    ...
    headers = ["SI", "Order ID", "Order Date", "Customer Name", "Customer Phone", "Seller", "Total Amount", "Payment Status", "Order Status", "Delivery Type"]
    rows = orders.map((order, index) => [
      index + 1,
...
export const exportToExcel = (orders, filename = "orders") => {
  ...
  if (isSubscription) {
    ...
    headers = ["SI", "Order ID", "Order Date", "Order Time", "Customer Name", "Customer Phone", "Seller Name", "Delivery Boy Name", "Delivery Boy Phone", "Status", "Total Amount", "Payment Status"]
    rows = orders.map((order, index) => {
