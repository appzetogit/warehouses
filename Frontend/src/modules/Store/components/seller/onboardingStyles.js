export const SELLER_BRAND = "#FD920B"
export const SELLER_BRAND_RGB = "253,146,11"
export const SELLER_BRAND_INK = "#B45309"
export const SELLER_BRAND_HOVER = "#E07F00"

export const ONBOARDING_FONT =
  "'Inter', system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif"

export const ONBOARDING_STEPS = [
  { id: 1, title: "Seller Info", subtitle: "Name, owner & location" },
...
export const ONBOARDING_INPUT =
  "mt-2 h-11 rounded-xl border border-gray-200 bg-white text-sm text-gray-900 shadow-sm transition-all placeholder:text-gray-400 focus-visible:ring-2 focus-visible:ring-wh-brand/20 focus-visible:border-wh-brand/50 disabled:cursor-not-allowed disabled:bg-gray-50 disabled:text-gray-500"

export const ONBOARDING_TEXTAREA =
  "mt-2 min-h-[96px] rounded-xl border border-gray-200 bg-white text-sm text-gray-900 shadow-sm transition-all placeholder:text-gray-400 focus-visible:ring-2 focus-visible:ring-wh-brand/20 focus-visible:border-wh-brand/50 disabled:bg-gray-50"
...
export const ONBOARDING_CHIP_ACTIVE =
  "bg-wh-brand text-wh-text border-wh-brand shadow-sm shadow-wh-brand/20"

export const ONBOARDING_CHIP_INACTIVE =
  "bg-white text-gray-700 border-gray-200 hover:border-gray-300 hover:bg-gray-50"

export const ONBOARDING_DAY_ACTIVE =
  "bg-wh-brand text-wh-text border-wh-brand shadow-sm shadow-wh-brand/15"
...
export const ONBOARDING_UPLOAD_BOX =
  "mt-2 rounded-xl border border-dashed border-gray-300 bg-gray-50/80 px-4 py-4 transition-colors hover:border-wh-brand/40 hover:bg-wh-brand/5"

export const ONBOARDING_UPLOAD_BTN =
  "h-10 rounded-xl border-gray-200 text-sm font-medium text-gray-700 hover:border-wh-brand/30 hover:bg-wh-brand/5 hover:text-wh-brand-ink"

export const ONBOARDING_INFO_BOX =
  "rounded-2xl border border-wh-brand/15 bg-wh-brand/5 p-5 sm:p-6"

export const ONBOARDING_PLAN_CARD =
  "flex h-full flex-col rounded-2xl border border-gray-200 bg-white p-5 shadow-sm transition-all hover:border-wh-brand/25 hover:shadow-md"
