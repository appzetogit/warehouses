...
export default function FinanceDetailsPage() {
  ...
  const sellerData = location.state?.sellerData || null
  ...
  const settlementData = useMemo(() => {
    ...
    const sellerDiscount = walletOrders.reduce(
      (sum, order) => sum + Number(order?.sellerDiscountShare || 0),
      0,
    );
    ...
    return {
      ...
      netOrderValue: {
        ...
        sellerDiscountPromos: sellerDiscount,
        sellerDiscountOthers: 0,
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <h1 className="text-lg font-bold text-gray-900 truncate">
              {sellerData?.name || "Your Store"}
            </h1>
            <p className="text-xs text-gray-600 mt-0.5">
              ID: {sellerData?.sellerId || "N/A"} • {sellerData?.address || "Location"}
            </p>
          </div>
        </div>
      </div>
                          ...
                          >
                            <div className="px-4 pb-3 space-y-2 border-t border-dashed border-gray-200">
                              ...
                              <div className="flex items-center justify-between py-2 border-t border-dashed border-gray-200">
                                ...
                                <span className="text-sm font-medium text-gray-900">
                                  ₹{settlementData.netOrderValue.sellerDiscountPromos.toLocaleString('en-IN', { minimumFractionDigits: 2 })}
                                </span>
                              </div>
                              <div className="flex items-center justify-between py-2 border-t border-dashed border-gray-200">
                                <div className="flex items-center gap-1.5">
                                ...
                                <span className="text-sm font-medium text-gray-900">
                                  ₹{(settlementData.netOrderValue?.sellerDiscountOthers || 0).toLocaleString('en-IN', { minimumFractionDigits: 2 })}
                                </span>
                              </div>
                            </div>
                          </motion.div>
                        ...
                        {expandedSections.taxDeductions && (
                          ...
                          >
                            <div className="px-4 pb-3 space-y-2 border-t border-dashed border-gray-200">
                              ...
                              <div className="flex items-center justify-between py-2 border-t border-dashed border-gray-200">
                                <div className="flex items-center gap-1.5">
                                  <span className="text-sm text-gray-700">GST paid by Zomato on behalf of the seller u/s 9(5) of GST</span>
                                  <Info className="w-3.5 h-3.5 text-gray-400" />
                                </div>
                                <span className="text-sm font-medium text-gray-900">
