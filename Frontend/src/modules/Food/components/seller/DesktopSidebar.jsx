...
export default function DesktopSidebar() {
  ...
  const [companyName, setCompanyName] = useState(() => getCompanyName() || "Seller")
  ...
  const sellerName = sellerData?.name || companyName || "Seller"
  const ownerName =
    sellerData?.ownerName ||
    sellerData?.owner?.name ||
    sellerData?.name ||
    "Owner"
  const ownerImage =
    sellerData?.profileImage?.url ||
    sellerData?.ownerImage?.url ||
    sellerData?.logo?.url ||
    ""
